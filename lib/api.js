...
export const equipCosmetic = (slot, cosmeticId) =>
  api.post('/profile/equip', { slot, cosmetic_id: cosmeticId }).then(r => r.data);

export const unequipCosmetic = (slot) =>
  api.post('/profile/equip', { slot, cosmetic_id: null }).then(r => r.data);

// ── Shop ──────────────────────────────────────────────────────────────────────
export const getShop = () =>
  api.get('/shop').then(r => r.data);

export const purchaseCosmetic = (cosmeticId) =>
  api.post('/shop/purchase', { cosmetic_id: cosmeticId }).then(r => r.data);
