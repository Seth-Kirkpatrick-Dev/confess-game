...
export async function GET(request, { params }) {
  try {
    ...
    const { data: confession, error } = await supabaseServer
      .from('confessions')
      .select('*, profiles(username, tier, avatar_config, featured_badge_icon, equipped_name_color_class, equipped_border_class, equipped_avatar_emoji, equipped_badge_frame_class, equipped_accent_color)')
      .eq('id', id)
      .eq('is_deleted', false)
      .single();
